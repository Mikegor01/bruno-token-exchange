...
contract("Exchange", ([deployer, feeAccount, user1, user2]) => {
    ...
    describe("depositing tokens", () => {
        ...
        describe("failure", () => {
            ...
            it("fails when no tokens are approved", async () => {
                //Don't approve any tokens before deposting
    ...
    describe("withdrawing tokens", async () => {
        ...
        describe("failure", async () => {
            it("rejects Ether withdraws", async () => {
                await exchange.withdrawToken(ETHER_ADDRESS, tokens(0), { from: user1 }).should.be.rejectedWith(EVM_Revert)
            })
    ...
    describe("making orders", async () => {
        ...
        it("tracks the newly created order", async () => {
            ...
            order.id.toString().should.equal("1", "id s correct")
        ...
        it("emits an Order event", async () => {
            ...
            const event = log.args
            event.id.toString().should.equal("1", "id s correct")
        ...
        describe("cancelling orders", async () => {
            ...
            describe("failure", async () => {
                ...
                it("rejects unauthorized cancelations", async () => {
                    //Try to cancel from another user
